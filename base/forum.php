...
function forum_declarer_tables_interfaces($interfaces) {
	...
	$interfaces['exceptions_des_jointures']['spip_forum']['id_mot'] = ['spip_mots', 'id_mot'];
	$interfaces['exceptions_des_jointures']['spip_forum']['titre_mot'] = ['spip_mots', 'titre'];
	$interfaces['exceptions_des_jointures']['spip_forum']['type_mot'] = ['spip_mots', 'type'];
	$interfaces['exceptions_des_jointures']['spip_forum']['id_groupe'] = ['spip_mots', 'id_groupe'];
	...
	$interfaces['table_des_traitements']['TEXTE']['forums'] = 'liens_nofollow(safehtml(' . str_replace(
		'%s',
		'interdit_html(%s)',
		_TRAITEMENT_RACCOURCIS
	) . '))';
	$interfaces['table_des_traitements']['TITRE']['forums'] = 'liens_nofollow(safehtml(' . str_replace(
		'%s',
		'interdit_html(%s)',
		_TRAITEMENT_TYPO
	) . '))';
	$interfaces['table_des_traitements']['NOTES']['forums'] = 'liens_nofollow(safehtml(' . str_replace(
		'%s',
		'interdit_html(%s)',
		_TRAITEMENT_RACCOURCIS
	) . '))';
	$interfaces['table_des_traitements']['NOM_SITE']['forums'] = 'liens_nofollow(safehtml(' . str_replace(
		'%s',
		'interdit_html(%s)',
		_TRAITEMENT_TYPO
	) . '))';
