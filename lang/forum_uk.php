...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'bouton_radio_publication_immediate' => 'Публікація коментарів без перевірки  (адміністратори можуть   видалити їх).',

	// D
	'documents_interdits_forum' => 'Заборонено додавати файли у коментарі форума',
	...
	// F
	'form_pet_message_commentaire' => 'Залишити коментар',
	'forum' => 'Форум',
	'forum_acces_refuse' => 'Ви більше не маєте доступу до цих форумів.',
	'forum_attention_dix_caracteres' => 'Увага! Текст вашого коментаря має містити щонайменше 10 символів.',
	'forum_attention_message_non_poste' => 'Ваше коментар ще не опублікован на сайті!',
	'forum_attention_nb_caracteres_mini' => '<b>Увага!</b> Ваш коментар має бути не менше @min@ символів.',
	'forum_attention_trois_caracteres' => '<b>Увага!</b> Заголовок має бути не менше трьох символів.',
	'forum_attention_trop_caracteres' => '<b>Увага!</b> Ваш коментар містить (@compte@ caractères) символів, ми можемо його опублікувати якщо розмір не перевищує @max@ символів.',
	...
	'forum_forum' => 'форум',
	'forum_info_modere' => 'На цьому форумі здійснюється премодерація: ваш коментар буде опубліковано після перевірки адміністратором.',
	'forum_lien_hyper' => 'Гіпертекстове посилання',
	'forum_message' => 'Ваш коментар',
	'forum_message_definitif' => 'Надіслати до публікації',
	'forum_message_trop_long' => 'Ваш коментар занадто довгий. Максимальний розмір становить 20000 символів.',
	'forum_ne_repondez_pas' => 'Не відповідайте на цей лист, але перейдіть на форум за наступним посиланням:',
	...
	'icone_poster_message' => 'Опублікувати коментар',
	'icone_suivi_forum' => 'Моніторинг форуму загального сайту: @nb_forums@ коментарі(в)',
	'icone_suivi_forums' => 'Управління форумами',
	'icone_supprimer_message' => 'Видалити коментар',
	'icone_supprimer_messages' => 'Видалити коментарі',
	'icone_valider_message' => 'Підтвердити коментар',
	'icone_valider_messages' => 'Опублікувати коментар',
	'icone_valider_repondre_message' => 'Затвердити та відповісти',
	'info_1_message_forum' => '1 повідомлення',
	'info_activer_forum_public' => 'Для активації форумів на публічній сторінці сайту оберіть режим модерації:',
	'info_appliquer_choix_moderation' => 'Застосувати режим модерації:',
	...
	'info_forcer_previsualisation_court' => 'Обов’язколвий попередній перегляд',
	'info_forcer_previsualisation_long' => 'Обов’язковий попередній перегляд перед відправкою коментаря',
	...
	// R
	'repondre_message' => 'Відповісти на коментар',
